...
//. . . || . . . || . . . || . . . ------ MOON713STONE ------ . . . || . . . || . . . || . . . || . . . || . . . || . . .
    ...
    // Statement : 
    // You Have An Array . Perform Q operation Between L To R , Add x 
    // Print Final Array 
    // Input : Array : 3 7 1 4 2 9 2
    // Q :  4 operation 
    // 1 to 4  , 2
    // 1 to 7  , 1
    // 3 to 6 , 3
    // 2 to 4 , 1
    // Final Array : 6 11 8 11 6 13 3 
    //Similar : https://cses.fi/problemset/task/1619
...
{ 
    ...
    //idea is we creat a temp array with all 0 ...then persorm operation and add it in the main array
}
